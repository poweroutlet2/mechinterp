...
runners = {
    ...
    "qwen2.5-3b-instruct": "Qwen2_5_3B_InstructModelRunner",
}

# Declare runner classes per model
...
Qwen2_5_3B_InstructModelRunner = build_runner(
    "Qwen2_5_3B_InstructModelRunner", "qwen2.5-3b-instruct", gpu="L40S"
)
